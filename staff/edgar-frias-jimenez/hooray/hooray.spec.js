...
describe('hooray', function () {
    ...
    describe('concat', function(){
        !true && it('should merge two arrays into one', function(){
          var array1 = ['a', 'b', 'c'];
          var array2 = ['d', 'e', 'f'];
        ...
        !true && it('will breaks if one value provided is void', function() {
          var array1 = ['a', 'b', 'c'];
        ...
        !true && it('will breaks if one array is undefined', function(){
          var array1 = ['a', 'b', 'c'];
          var array3;
